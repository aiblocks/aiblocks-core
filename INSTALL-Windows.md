...
Note that you can (and should) install the Windows version of postgres even when running aiblocks-core from within WSL.


# Basic Installation

- `git clone PATH_TO_AIBLOCKS_CORE`
- `git submodule init`
- `git submodule update`
- Open the solution `Builds\VisualStudio\aiblocks-core.sln`
