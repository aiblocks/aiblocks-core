...
- **Ledger**: A ledger is the state of the distributed AiBlocks database at a
...
- **Ledger header**: The ledger's header contains meta data about the ledger,
  ...
  own hash. (See [`src/xdr/AiBlocks-ledger.x`](/src/xdr/AiBlocks-ledger.x))


`AiBlocks-core` maintains the content of the latest ledger and of the ledger
...
performance needs.
 ...
 4. Finally, `aiblocks-core` can be configured to upload detailed historical
