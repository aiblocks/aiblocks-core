---
title: Ledger state and transaction simulation in aiblocks-core
---

Minimum supported ledger version: 12

aiblocks-core has built-in functionality to scale any existing ledger state by a specific multiplier,
...
`aiblocks-core simulate-bucketlist <L> --multiplier <MULTIPLIER>`
...
`aiblocks-core simulate-transactions --first-ledger-inclusive <F> --last-ledger-inclusive <L>`
