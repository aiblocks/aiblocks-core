...
Two slightly-obscurely-named components are:
  ...
  - SCP -- "AiBlocks Consensus Protocol", the component implementing the
    [consensus algorithm](https://www.aiblocks.io/papers/aiblocks-consensus-protocol.pdf).
...
- Set of core validator nodes. Running aiblocks-core only. Tasked with:
...
- Set of public HTTP nodes. Not running aiblocks-core. Running
...
- (optional): Set of public validator nodes. Running aiblocks-core only. Tasked
with:
  ...
  - Basically just a aiblocks-network load balancer / firewall for public access,
